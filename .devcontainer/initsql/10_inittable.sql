...
CREATE TABLE KCCMJUCHU (
    CMJUCHU_DATA_KBN NUMERIC(1),
    CMJUCHU_JUCHU_NO NUMERIC(4) PRIMARY KEY,
    CMJUCHU_JUCHU_DATE CHAR(6),
    CMJUCHU_SHOHIN_NO CHAR(5),
    CMJUCHU_SURYO NUMERIC(5)
);


INSERT INTO KCCMJUCHU (CMJUCHU_DATA_KBN, CMJUCHU_JUCHU_NO, CMJUCHU_JUCHU_DATE, CMJUCHU_SHOHIN_NO, CMJUCHU_SURYO) VALUES 
(1, 0001, '260611', '10001', 00010),
(1, 0002, '260611', '10003', 00005),
(1, 0003, '260611', '99999', 00001),
(1, 0004, '260611', '10001', 00000)
;